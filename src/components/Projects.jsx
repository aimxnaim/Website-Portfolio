    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between px-4 py-2 border-b border-neutral-700/40">
                <span className={`pixel-font text-[8px] ${rarity.color}`}>{rarity.label}</span>
                <span className="pixel-font text-[8px] text-neutral-600">CLICK TO VIEW</span>
            </div>
                ...
                <div className="flex gap-2 flex-wrap">
                    {project.githubLink && (
                        <a
                            ...
                            className="pixel-font text-[8px] flex items-center gap-1.5 px-3 py-1.5 border border-gold-400/30 text-gold-400/80 hover:bg-gold-400/10 hover:border-gold-400/60 transition-colors"
                        >
                            <FaGithub /> GITHUB
                        </a>
                    )}
        ...
        <div className="px-5 pt-4 pb-4">
            ...
            {project.githubLink && (
                <a
                    ...
                    rel="noreferrer"
                    onClick={(e) => e.stopPropagation()}
                    className="pixel-font text-[8px] inline-flex items-center gap-1.5 mt-3 px-3 py-1.5 border border-neutral-700 text-neutral-500 hover:border-gold-400/40 hover:text-gold-400/70 transition-colors"
                >
                    <FaGithub /> GITHUB
                </a>
            )}
...
const Projects = () => {
    ...
    return (
        <div className="pb-4">
            ...
            >
                <span className="pixel-font text-[9px] text-gold-400/60 tracking-[0.15em] w-full">◄ PROJECTS ►</span>
            ...
            <div className="max-w-5xl mx-auto px-2 flex flex-col items-center gap-10">
                {/* Featured projects */}
                <div>
                    <p className="pixel-font text-[8px] text-gold-400/50 text-center mb-5 tracking-widest">FEATURED PROJECTS</p>
                ...
                {/* Other projects */}
                <div>
                    <p className="pixel-font text-[8px] text-neutral-600 text-center mb-5 tracking-widest">OTHER PROJECTS</p>
                    <div className="flex flex-wrap justify-center gap-6">
