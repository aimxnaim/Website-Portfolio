    ...
    return (
        <div className=" pb-4">
            ...
            <div className="flex flex-wrap justify-center gap-8">
                {PROJECTS.map((project, index) => (
                    <div key={index} className="lg:mt-14 lg:mb-14 relative max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"> {/* Add mb-10 for margin bottom */}
